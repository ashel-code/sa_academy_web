    ...
    return Container(
      child: Column(
        children: [
          ...
          SizedBox(height: schemeIndent),
          Text(
            "Тебя ждет проект, который ты создашь вместе с командой и добавишь в свое портфолио!",
            style: normalBlackTextStyle(normalTextSize),
            textAlign: TextAlign.center,
          ),
          SizedBox(height: 25),
  ...
  Widget firstTime() {
    return Column(
      ...
      children: [
        ...
        Text(
          "Записывайтесь через форму регистрации на сайте.",
          style: normalTextStyle(normalTextSize),
          textAlign: TextAlign.start,
        ),
      ],
